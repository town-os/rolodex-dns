...
**Extendidos**: URI (RFC 7553), SSHFP (RFC 4255), DNAME (RFC 6672), ANAME (alias resuelto en el momento de la consulta), ZONEMD (RFC 9156), TLSA (RFC 6698), CERT (RFC 4398).

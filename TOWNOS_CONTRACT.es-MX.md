...
> Idiomas: [English](TOWNOS_CONTRACT.md) | [繁體中文](TOWNOS_CONTRACT.zh-TW.md) | [简体中文](TOWNOS_CONTRACT.zh-CN.md) | [Español (España)](TOWNOS_CONTRACT.es-ES.md) | **Español (México)** | [日本語](TOWNOS_CONTRACT.ja-JP.md)
...
- **No ordenar ni reordenar la lista de reenviadores para expresar preferencia.** El orden dentro de un escalón se respeta — es la secuencia que rolodex prueba — pero el escalón mismo se deriva. Una lista ordenada por Town OS con "los cifrados primero" es redundante en el mejor caso y, si esa ordenamiento discrepa de la derivación de rolodex, engañosa en los registros.
...
## Exigido de Town OS: el resolvedor de DHCP no es descubrible desde resolv.conf
...
- ttyforce escribe `[DHCPv4] UseDNS=no` (y el equivalente v6) en sus unidades de networkd, así que los resolvedores ofrecidos por DHCP nunca llegan a ser un resolvedor por enlace que superase a rolodex.
